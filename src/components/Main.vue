...
onMounted(() => {
    ...
    if (savedBookmarks) {
        ...
        bookmarks.push(
            {
                "icon": "<svg t=\"1726371142192\" class=\"icon\" viewBox=\"0 0 1024 1024\" version=\"1.1\" xmlns=\"http://www.w3.org/2000/svg\" p-id=\"9823\" width=\"200\" height=\"200\"><path d=\"M153.813 0L358.4 71.936v719.957l288.128-166.186-141.227-66.347-89.173-221.867 453.973 159.488v231.894L358.528 1024 153.856 910.08V0z\" fill=\"#0065F3\" p-id=\"9824\"></path></svg>",
